        ...
        <div class="flex">
          <div class="py-6 lg:block hidden">
            ...
            >
              ...
              <li><a class="link" href="about.php" >Why TMN</a></li>
  ...
  >
        <li class="px-4 py-1 rounded-2xl hover:bg-[#ababab]/10 inset-1"><a class="link"  href="programs.meetup.php" >Meetups</a></li>
        <li class="px-4 py-1 rounded-2xl hover:bg-[#ababab]/10 inset-1"><a  class="link" href="insightIndex.php" >Insight</a></li>
  ...
  >
    <li class="px-4 py-1 rounded-xl hover:bg-gray-100">
      <a class="link" href="chapter.php">Chapter</a>
    </li>
    <li class="px-4 py-1 rounded-xl hover:bg-gray-100">
      <a class="link" href="events.php">Events</a>
    </li>
    <li class="px-4 py-1 rounded-xl hover:bg-gray-100">
      <a class="link" href="story.php">Story</a>
    </li>
    <li class="px-4 py-1 rounded-xl hover:bg-gray-100">
      <a class="link" href="articles-new.php">Articles</a>
    </li>
    <li class="px-4 py-1 rounded-xl hover:bg-gray-100">
      <a class="link" href="buildBrand.php">Build Your Brand</a>
    </li>
  </ul>
</li>
  <li><a class="link" href="advisory-committee.php">Advisory Panel</a></li>
             <li class="relative group cursor-pointer">Associations
     <ul
    class="absolute w-[200px] bg-white border rounded-lg shadow-md top-full left-0 p-4 opacity-0 translate-y-2 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:translate-y-0 pointer-events-none group-hover:pointer-events-auto space-y-2"
  >
        <li class="px-4 py-1 rounded-2xl hover:bg-[#ababab]/10 inset-1"><a class="link"  href="partners.php" >Partners</a></li>
        <li class="px-4 py-1 rounded-2xl hover:bg-[#ababab]/10 inset-1"><a  class="link" href="sponsors.php" >Sponsors</a></li>
        ...
        <a href="journey.php" class="bg-secondary w-[150px] lg:flex hidden items-center justify-center text-white xl:text-[16px] lg:text-[11px]" >  <div
