...
<div class="max-w-4xl mx-auto mt-10 bg-white shadow-lg rounded-xl p-8">
    ...
    <form action="{{ route('admin.stories.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
        ...
        <div>
            ...
            <input name="industry" class="w-full bg-white border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-red-400 outline-none px-3 py-2">
        </div>
        ...
        <div>
            ...
            <input type="file" name="image" class="w-full bg-white border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-red-400 outline-none px-3 py-2">
        </div>
