...
<div class="max-w-4xl mx-auto mt-10 bg-white shadow-lg rounded-xl p-8">
  ...
  <form action="{{ route('admin.consultations.store') }}" method="POST" class="space-y-5">
    ...
    <div>
      ...
      <input name="type" class="w-full border rounded px-3 py-2" placeholder="e.g. Marketing, Finance, Strategy">
    </div>

    <div class="grid grid-cols-2 gap-4">
      <div>
        <label class="block text-gray-700 font-medium">Consultation Date</label>
        <input type="date" name="consultation_date" class="w-full border rounded px-3 py-2">
      </div>
      <div>
    ...
    <div>
      ...
      <input name="meeting_link" class="w-full border rounded px-3 py-2" placeholder="Zoom link or physical address">
    </div>

    <div>
      <label class="block text-gray-700 font-medium">Consultant Name</label>
      <input name="consultant_name" class="w-full border rounded px-3 py-2">
    </div>

    <div>
      <label class="block text-gray-700 font-medium">Client Name</label>
      <input name="client_name" class="w-full border rounded px-3 py-2">
    </div>
