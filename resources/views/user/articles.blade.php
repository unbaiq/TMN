...
{{-- ================= BANNER ================= --}}
<section class="bg-[url({{ config('app.url') }}/images/committee-banner.png)] bg-cover bg-center bg-no-repeat">
        ...
        <aside>
            ...
            <div class="px-4 mt-14">
                ...
                <div class="flex gap-2 mt-4">
                    <div class="border border-red-600 w-[40px] h-[40px] rounded-full flex items-center justify-center text-[#CF2031] hover:bg-[#CF2031] hover:text-white transition">
            ...
            <div class="px-4 mt-14">
                ...
                @foreach($latestArticles as $latest)
                    <a href="{{ route('articles.show', $latest->slug) }}"
                       class="grid grid-cols-[90px,1fr] gap-4 mt-4">
                        <img src="{{ $latest->thumbnail_url }}"
