...
<head>
  ...
  <link rel="shortcut icon" href="{{ $assetBase }}/images/favicon.png" type="image/x-icon" />
      ...
      <div class="grid xl:grid-cols-[50%,1fr] grid-cols-1 items-start lg:gap-10 gap-9">
        ...
        <div class="xl:order-1 order-2 relative p-10">
          ...
          <form method="POST" action="{{ route('enquiry.submit') }}" id="enquiryForm">
            ...
            <div class="step active" data-step="1">
              ...
              <h2
                class="text-[#78818A] lg:text-[45px] md:text-[25px] text-[23px] font-medium leading-[35px] lg:pb-6 pb-4">
        ...
        <div class="xl:order-2 order-1 bg-[#f8f8f8] p-6 rounded">
          <div class="grid grid-cols-2">
            <div>
              <img src="{{ $assetBase  }}/images/image.png" class="w-[65%] mx-auto" alt="BNI Member">
            </div>
            <div>
