...
<section class="pt-10 text-[#232323] bg-[#f2f2f2]">
    <div class="main-width">
        <p class="leading-[25px] text-[16px]">
            <span class="font-bold">Top Management Network</span> (TMN), we believe that great leadership thrives on
            expert guidance and strategic insights. Our Advisory Panel is composed of highly accomplished business
            leaders, industry veterans, and subject matter experts who bring unparalleled experience and wisdom to our
            network. These advisors play a pivotal role in mentoring entrepreneurs, executives, and professionals,
            helping them navigate challenges and achieve long-term growth.

            <br> <br>
            <b>
                <p>Meet Our Esteemed Advisors</p>
            </b><br>
            Our advisory board consists of renowned business leaders, successful entrepreneurs, corporate strategists,
            and financial experts. These professionals contribute their expertise to empower TMN members and guide them
            towards growth, profitability, and leadership excellence.
            <br> <br>
            Each advisor brings unique strengths, ranging from business development and financial planning to marketing
            strategies and operational efficiency. With their mentorship, TMN members can confidently make decisions
...
<section class="py-10 bg-[#f2f2f2]">
    <div class="main-width grid lg:grid-cols-2 gap-4 mt-4">
        ...
        @forelse($advisories as $advisory)
            ...
            <div
                class="grid xl:grid-cols-[30%,1fr] md:grid-cols-[50%,1fr] gap-2 transition-all duration-700 hover:shadow-md bg-white p-4">
                ...
                <div class="w-full pt-4 text-center">
                    ...
                    <div class="w-[60%] mx-auto flex items-center justify-around py-2">
                        <span
                            class="border-red-600 border flex items-center justify-center w-[40px] h-[40px] rounded-full text-[#CF2031] hover:bg-[#CF2031] hover:text-white transition">
