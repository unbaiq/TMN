    ...
    <section class="py-10 ">
        <div class="main-width grid grid-cols-2 items-center py-2 ">
            <div>
                ...
                <div class="mt-6">
                    <span class="font-medium text-[20px] border text-white bg-primary rounded  ttansion-all duration-700 hover:bg-white hover:border-[#CF2031] hover:text-[#CF2031] cursor-pointer px-4 py-3">
                        FREE CONSULTATION
                    </span>
                </div>
            </div>
