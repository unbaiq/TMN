            ...
            <div  class="grid grid-cols-[65%,1fr] gap-8">
                ...
                <div class="  relative bg-white ">
                    <div class="clip-design">
                        <img src="images/shobha-demo-image.webp" class="w-full h-full" alt=''/>
                    </div>
                    <div class="absolute bottom-2 pl-10 pt-8">
                        <div class="mb-[2px]">
                        <span class="text-sm ">February 5th, 2025</span>
                        </div>
                         <span class="text-[#CF2031] ">Bangalore, Buyers Guide, SOBHA</span>
                        
                        
                    </div>
                </div>
                <div class="px-8 pb-8  ">
                    <h2 class="text-[#232323] font-medium text-[35px] ">Is Sarjapur Road a Good Place to Live?</h2>
                    <p class=" text-[16px] font-normal lg:leading-[30px]">
                        Sarjapur Road Bangalore offers seamless connectivity, premium housing, and world-class infrastructure – making it an ideal destination for professionals, families, and investors seeking luxury, convenience, and long-term growth potential. Once a serene stretch of Bangalore, Sarjapur Main Road has transformed into a highly sought-after residential and investment hotspot. Seamless connection to IT hubs, premium gated […]
                    </p>
                    <div class="py-4 mt-4">
                        <span class="bg-red-600 rounded shadow text-white px-4 py-2  text-[17px] ">Continue Reading...</span>
                    </div>
