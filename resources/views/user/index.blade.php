@include("user.components.meta")
  ...
  <section>
          <style>
      @font-face { font-family: JuneBug; src: url('font/neuropolitical rg.otf'); } 
      .logoFont1 {
         font-family: JuneBug;
		 letter-spacing:10px;
      }
  ...
  @include("user.components.header")
    <section
      class="bg-[url({{ config('app.url') }}/images/banner.png)] bg-cover py-10 lg:bg-right bg-center bg-no-repeat"
    >
      <div class="main-width h-full py-4 flex items-center lg:justify-center">
        <div class="grid md:grid-cols-2 gap-6 items-center">
          ...
          <div class="">
            <img src="{{ config('app.url') }}/images/banner-i.png" class="mx-auto" alt="" />
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="px-3">
          ...
          <div class="leading-[25px] py-4">
            ...
            <p class="para text-justify">
             <span class="text-primary underline">Top Management Network</span> (TMN) is a platform designed to connect CXOs, business leaders, and industry professionals, fostering strategic networking, leadership growth, and business expansion. Our mission is to empower Top Management  and entrepreneurs by providing exclusive access to high-value industry insights, professional collaborations, and business opportunities. Through expert-led discussions, executive mentorship, and corporate partnerships, TMN helps professionals stay ahead in an evolving business landscape, whether you're looking to expand your network, explore new business ventures, or gain though leadership exposure, TMN is your gateway to success. Join us and be part of a powerful ecosystem that drives innovation, leadership excellence, and industry growth.
            </p>
    ...
    <section class="py-10">
      ...
      <br>
          <p class="para lg:w-[890px] text-center">
           	At Top Management Network (TMN), we provide a wide range of services to help CXOs, entrepreneurs, and industry leaders connect, collaborate, and grow. Our tailored solutions are designed to foster strategic partnerships, professional development, and business expansion.
          </p>
        </div>
...
@endforeach
      ...
      <button class="  text-white px-6 rounded-[5px] xl:text-[18px] text-[16px] lg:font-bold xl:leading-[32px] py-4"></button>
    </div>
