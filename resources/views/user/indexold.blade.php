        ...
        <div class="grid md:grid-cols-[58%,1fr] gap-6 items-center">
          <div h-full>
            ...
            <div class="bg-primary w-full px-4">
              <h1 class="heading2 text-white py-2 px-2">
    ...
    <section>
      <div class="main-width py-10 grid lg:grid-cols-[40%,1fr] gap-4">
        ...
        <div class="px-3">
          ...
          <h2 class="heading1 2xl:pt-6 font-semibold">
...
synergy to share Thoughts, Ideology, Challenges and create an environment suitable to personal and business Growth
          ...
          <p class="font-bold text-[20px]">
                Forecast <span class="text-primary "> 2025-2026</span>
            </p></div>
          <div class="pt-4 grid grid-cols-3 items-start">
            ...
            <div class="flex items-center lg:gap-6 gap-2">
              <div class="bg-[#000] w-[3px] h-[100px]"></div>
              <div class="p-2">
                <h2 class="md:heading2 text-[30px] text-primary !font-light">
                 28 +
                </h2>
          ...
          <script>
            ...
            const htmlContent = committeImage.map((data, index) => (
              `<div class="w-[300px]" key="${index}">
                <div class="w-[280px] flex items-center justify-center mx-auto relative h-[280px] rounded-full bg-white">
                  <div class="w-[90%]">
                    <img src="${data.img}" class="w-full rounded-full object-cover" alt="">
                  </div>
                  <div class="bg-red-600 rounded-[8px] absolute bottom-0 py-2 flex items-center justify-center gap-6 left-[25%] w-[150px] text-white">
                ...
                <div class="text-center py-4">
                  ...
                  <h6 class="text-[#232323] text-[20px] font-normal leading-[24px]">${data.exp}</h6>
                </div>
              </div>`
            ));
  ...
  <div class=" overflow-hidden relative ">
    ...
    <section class="bg-[#F8F8F8] py-10">
      <div class="main-width">
        ...
        <div class="p-4 flex items-start flex-wrap gap-10 justify-center " id="committee-containerr">
          <script>
...
<div class=" rounded-[40px] shadow-[0px_4px_20px_0px_rgba(129,129,129,0.25)] over flow-hiddenn  bg-[#fff] ">
  <div class="w-full">
    <img src="images/blog.png" class="w-full h-full" alt="">
  </div>
<div class="xl:p-8 p-4">
  <p class="font-semibold xl:leading-[36px] md:text-[22px] text-[19px] xl:text-[32px]">
    Corporating Others Is Must In Business
  </p>
  <p class="font-normal xl:leading-[30px]">Sep 28, 2024  No Comments</p>
</div>
...
<div class="xl:p-8 p-4">
  <p class="font-semibold xl:leading-[36px] md:text-[22px] text-[19px] xl:text-[32px]">
    Creating Daily Activities For Flowless Business
  </p>
  <p class="font-normal xl:leading-[30px]">Sep 28, 2024  No Comments</p>
</div>
