  ...
  <div class="main-width flex items-center justify-between pr-4 lg:pr-0">
    ...
    <div class="flex">
      <div class="py-6 lg:block hidden">
        <ul class="flex xl:space-x-6 lg:space-x-4   px-4 items-center xl:text-[14px] 2xl:text-[16px] lg:text-[11px]">
          ...
          <li class="relative group cursor-pointer">Program
            <ul
              ...
              <li class="px-4 py-1 rounded-2xl hover:bg-[#ababab]/10 inset-1"><a class="link"
                  href="/programs-meetup">Meetups</a></li>
              <li class="px-4 py-1 rounded-2xl hover:bg-[#ababab]/10 inset-1"><a class="link"
                  href="/insightindex">Insight</a></li>
