    ...
    <form action="{{ route('member.investors.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="investor_name" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-1 focus:ring-red-600 focus:border-red-600">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" name="investment_focus" placeholder="Technology, Real Estate..." class="w-full border border-gray-300 rounded-lg px-3 py-2">
            </div>
            <div>
                <label class="text-sm text-gray-600">Investment Capacity (₹)</label>
                <input type="number" step="0.01" name="investment_capacity" class="w-full border border-gray-300 rounded-lg px-3 py-2">
            </div>
            <div>
