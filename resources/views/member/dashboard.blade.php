...
<div class="max-w-8xl mx-auto px-4 py-6 space-y-8">
    ...
    {{-- HEADER --}}
    <div class="bg-gradient-to-r from-red-700 via-red-600 to-red-500 rounded-2xl shadow-2xl px-10 py-8 text-white flex flex-col md:flex-row md:items-center md:justify-between relative overflow-hidden">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        {{-- Actual Business --}}
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition duration-300">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
        {{-- Referrals --}}
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {{-- Visitors --}}
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition space-y-3">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition space-y-3">
            ...
            <div class="grid grid-cols-3 gap-4 text-sm mt-2">
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-800">₹ {{ number_format($csrImpact->total_amount ?? 0, 2) }}</p>
                </div>
                <div>
            ...
            <p class="mt-3 text-xs text-gray-400">Investors Linked: <span class="font-semibold text-gray-700">{{ $investorCount }}</span></p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition space-y-3">
            ...
            <div class="grid grid-cols-3 gap-4 text-sm mt-2">
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-800">₹ {{ number_format($recognitionStats->total_recognition_value ?? 0, 2) }}</p>
                </div>
                <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {{-- Line Chart --}}
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 lg:col-span-2 hover:shadow-lg hover:-translate-y-1 transition">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition">
            ...
            <p class="mt-3 text-xs text-gray-500 leading-relaxed">Shows distribution of your activities: referrals, 1-1, visitors, thank you etc.</p>
        </div>
    </div>
</div>
@endsection
