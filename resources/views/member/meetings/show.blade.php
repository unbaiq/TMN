...
<div class="w-full px-6 py-10">
    ...
    <div class="bg-gradient-to-r from-red-700 via-red-600 to-red-500
                text-white rounded-2xl shadow-xl px-10 py-8
        ...
        <a href="{{ $meeting->meeting_type === '1to1'
           ...
           class="inline-flex items-center gap-2
                  bg-white text-red-600 px-4 py-2.5
                  rounded-lg font-medium shadow hover:bg-gray-100">
    ...
    <div class="mt-10 bg-white rounded-2xl shadow-xl p-8
        ...
        {{-- ================= PARTICIPANTS ================= --}}
        <div class="border-t border-gray-100 pt-6">
            <h4 class="text-gray-500 text-xs uppercase mb-3">
                Participants
            ...
            @if($meeting->participants->isEmpty())
                <p class="text-sm text-gray-500">No participants added.</p>

            {{-- 1-TO-1 MEETING --}}
            @elseif($meeting->meeting_type === '1to1')
                @php $p = $meeting->participants->first(); @endphp

                <div class="flex items-center gap-4
                            bg-gray-50 rounded-lg p-4 w-full md:w-1/2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">1-to-1 Participant</p>
                    </div>
                </div>
        ...
        @if($meeting->key_discussion_points || $meeting->outcomes)
            <div class="border-t border-gray-100 pt-6 space-y-4">
                @if($meeting->key_discussion_points)
                    <div>
                        <h4 class="text-gray-500 text-xs uppercase mb-1">
